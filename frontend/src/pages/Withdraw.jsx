    ...
    <DashboardLayout>
      ...
      <div className="max-w-3xl mx-auto">
        ...
        {selectedAccount && (
          ...
          <div className="bg-gradient-to-r from-red-500 to-red-700 rounded-3xl text-white p-8 shadow-lg mb-8">
          ...
          >
            ...
            <div>
              ...
              <select
                ...
                className="w-full mt-2 border border-slate-300 rounded-xl p-4 focus:ring-2 focus:ring-red-500 outline-none"
              >
                {accounts.map((acc) => (
                  <option
                    key={acc.id}
            ...
            <div>
              ...
              <div className="relative mt-2">
                ...
                <input
                  ...
                  className="w-full border border-slate-300 rounded-xl pl-12 pr-4 py-4 focus:ring-2 focus:ring-red-500 outline-none"
                />
            ...
            {selectedAccount && (
              <div className="flex items-center gap-3 bg-yellow-50 text-yellow-700 rounded-xl p-4">
                <FaExclamationTriangle />
                Available Balance:
                <strong>
                  ₹{selectedAccount.balance.toLocaleString()}
